...
import { Component, Material, Node, SpriteAtlas, SpriteFrame, UIRenderer, UITransform } from 'cc';
...
export declare abstract class AEventHandler<T, A> {
	protected abstract run(scene: T, args: A): any;
	handleAsync(scene: T, a: A): Promise<void>;
	handle(scene: T, a: A): void;
}
/**
 * 事件基类
 */
 ...
 * @returns
 */
export declare function EventDecorator(eventCls: Type<AEvent>, sceneType: string): (target: () => any) => void;
